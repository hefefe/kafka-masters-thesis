...
public class KafkaEmailEventConsumer {
    ...
    private static final List<Integer> values = List.of(0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1200, 1400, 1600, 1800, 2000, 2500, 3000);

    public KafkaEmailEventConsumer(Counter opsCounter, MeterRegistry meterRegistry) {
